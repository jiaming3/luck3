     ...
     while True:
        ...
        try:
            ...
            if manual_message=="manual_backward":
                stabilizer, counter = func_sensor(40, 0, 0, counter, max_num, move_time, stabilizer,current_rotate_position,rotate_time)
        ...
        try:
          ...
          stabilizer, counter = func_sensor(t,hu,p,counter,max_num,move_time,stabilizer,current_rotate_position,rotate_time)
